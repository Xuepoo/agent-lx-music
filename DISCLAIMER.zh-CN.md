...
本项目基于 **MIT** 许可证发行，以下协议是对于 MIT 许可证的补充，如有冲突，以以下协议为准。

### 词语约定
*   **“本项目”**：指 `agent-lx-music` (`alx`) 音乐终端版项目。
*   **“使用者”**：指签署或默认接受本协议的使用者。
*   **“官方音乐平台”**：指对本项目内置或支持的包括酷我、酷狗、咪咕等音乐源的官方平台统称。
*   **“版权数据”**：指包括但不限于图像、音频、名字等在内的他人拥有所属版权的数据。
